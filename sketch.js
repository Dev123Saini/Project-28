...
function setup() {
	...
	attach1=new Chain(mango1.body,{x : 900, y : 100});
	attach2=new Chain(mango2.body,{x : 820, y : 200});
	attach3=new Chain(mango3.body,{x : 1000, y : 100});
	attach4=new Chain(mango4.body,{x : 990, y : 190});
	attach5=new Chain(mango5.body,{x : 1120, y : 170});
	attach6=new Chain(mango6.body,{x : 680, y : 190});
	attach7=new Chain(mango7.body,{x : 820, y : 140});
	attach8=new Chain(mango8.body,{x : 900, y : 180});
	attach9=new Chain(mango9.body,{x : 820, y : 80});
	attach10=new Chain(mango10.body,{x : 950, y : 60});

	ground=new Ground(width/2,490,width,20);

	stone=new Stone(138,380,10,10);

	stoneAttach=new Chain(stone.body,{x : 138, y : 380});
